...
deal-mgmt/app/ralph/gates/base.py에서 복제.
IM 모듈 독립 실행을 위해 별도 패키지로 유지한다.
"""
...
class QualityGate(ABC):
    ...
    Gate 1(프로그래밍)은 LLM 호출 없이 밀리초 단위로 동작한다.
    """

    @property
    @abstractmethod
    def name(self) -> str:
        """게이트 고유 이름 (예: 'pptx_programmatic')."""
        ...
