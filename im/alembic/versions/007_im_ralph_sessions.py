...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("learned_patterns", JSONB, nullable=True),
    ...
    op.create_index("ix_im_ralph_doc_pass", "im_ralph_sessions", ["document_id", "pass_number"])


def downgrade() -> None:
    op.drop_index("ix_im_ralph_doc_pass")
    op.drop_index("ix_im_ralph_status")
    op.drop_index("ix_im_ralph_document")
