  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-sm font-semibold text-text-primary">법률실사(LDD) 보고서</h3>
        ...
        <div className="flex gap-2">
          ...
          <button
            type="button"
            onClick={() => navigate(`/docs/ldd/new?txn_id=${txnId}&type=REDFLAG`)}
      ...
      {reports && reports.length > 0 && (
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="rounded-lg border border-amber-200 bg-caution-light px-4 py-3">
            <p className="text-xs text-amber-500 font-medium">High/Medium (Amber)</p>
      ...
      {!reports || reports.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border py-12 text-center">
          ...
          <div>
            <p className="text-sm font-medium text-text-secondary">생성된 LDD 보고서가 없습니다</p>
          ...
          <table className="w-full text-sm">
            <thead className="bg-white">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-text-tertiary">이슈 현황</th>
                ...
                <tr key={report.id} className="hover:bg-white-elevated/50">
                  ...
                  <td className="max-w-[180px] px-4 py-3">
                    ...
                    {report.target_company && (
                      <p className="text-xs text-text-tertiary truncate">{report.target_company}</p>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-3">
                    ...
                    {report.status === "FAILED" && report.error_message && (
                      <div className="mt-1 flex items-center gap-1 text-xs text-negative">
                        ...
                        <span className="truncate max-w-[120px]" title={report.error_message}>
                          오류 발생
                        </span>
                      </div>
                    )}
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button
                        ...
                        title={confirmDeleteId === report.id ? "다시 클릭하면 삭제됩니다" : "삭제"}
                      >
