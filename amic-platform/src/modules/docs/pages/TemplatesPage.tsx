...
import type { IMStyle, SectionId } from "@/modules/docs/types/document";
import { SECTION_LABEL_MAP } from "@/modules/docs/types/document";
...
const TEMPLATES: TemplateInfo[] = [
  {
    style: "TEASER",
    name: "Teaser Memorandum",
    description:
      "M&A 초기 단계에 잠재 투자자에게 배포하는 간결한 문서. 4개 그룹 고정 구조.",
    icon: FileText,
    sections: [
      "cover",
      "executive_summary",
  ...
  },
  {
    ...
    name: "Titan",
    description:
      "Concise investment summary focused on key highlights, financials overview, and deal rationale.",
    icon: Briefcase,
    sections: [
      "cover",
      "disclaimer",
  ...
  },
  {
    ...
    name: "Covenant",
    description:
      "Enhanced financial analysis with detailed covenant compliance, debt structure, and risk assessment.",
    icon: BarChart3,
    sections: [
      "cover",
      "disclaimer",
  ...
  },
  {
    ...
    name: "Full",
    description:
      "Comprehensive IM covering all sections including market analysis, management, and projections.",
    icon: Layers,
    sections: [
      "cover",
      "disclaimer",
  ...
  },
  {
    ...
    name: "Custom",
    description:
      "Build your own document by selecting specific sections tailored to your needs.",
    icon: Settings2,
    sections: null,
  },
];
  ...
  return (
    <div className="space-y-6">
      <PageHero
        ...
        subtitle="Choose a template style for your M&A document"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {TEMPLATES.map((template) => {
          const isTeaser = template.style === "TEASER";
          const targetPath = isTeaser
            ? "/docs/new?type=teaser"
            : `/docs/new?type=im&style=${template.style}`;
              ...
              <div className="flex items-start gap-4 p-6">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isTeaser && (
                      <span className="px-1.5 py-0.5 text-xs rounded bg-violet-100 text-violet-700">
                        TM
                      </span>
                    )}
                  </div>
