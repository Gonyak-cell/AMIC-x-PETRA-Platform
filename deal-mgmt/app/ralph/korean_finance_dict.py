...
DDRL_FILE_KEYWORDS: dict[str, dict[str, list[str]]] = {
    "GOVERNANCE": {
        "keywords": [
            "정관", "등기사항", "등기부", "이사회", "주주명부", "사업자등록증",
            "법인등기", "설립", "임원", "대표이사", "이사", "감사",
        ],
        "ddrl_prefixes": ["L1", "L2", "L3"],
    },
    "CAPITAL": {
        "keywords": [
            "주식", "자본금", "전환사채", "CB", "BW", "스톡옵션",
            "주주협약", "우선주", "신주인수", "유상증자", "ESOP",
        ],
        "ddrl_prefixes": ["L4", "L5"],
    },
    "CONTRACTS": {
        "keywords": [
            "계약서", "거래처", "고객계약", "공급계약", "금융계약",
            "라이선스", "리스", "임대차", "프랜차이즈", "대리점",
        ],
        "ddrl_prefixes": ["L12"],
    },
    "LITIGATION": {
        "keywords": [
            "소송", "분쟁", "행정처분", "제재", "과태료", "벌금",
            "형사", "민사", "조사", "감사원", "규제기관",
        ],
        "ddrl_prefixes": ["L14"],
    },
    ...
    "IP": {
        "keywords": [
            "특허", "실용신안", "상표", "디자인", "저작권",
            "소프트웨어", "라이선스", "지식재산", "IP", "발명",
        ],
        "ddrl_prefixes": [],
    },
    "REAL_ESTATE": {
        "keywords": [
            "부동산", "토지", "건물", "건축물대장", "등기부등본",
            "임대차", "저당권", "전세권", "환경", "오염",
        ],
        "ddrl_prefixes": ["L7"],
    },
    ...
    "TAX": {
        "keywords": [
            "세무", "세금", "법인세", "부가세", "부가가치세",
            "이전가격", "세무조사", "과세", "납부", "세무신고",
        ],
        "ddrl_prefixes": [],
    },
    "DATA_IT": {
        "keywords": [
            "개인정보", "정보보호", "ISMS", "ISO", "보안",
            "데이터", "IT", "시스템", "유출", "사고",
        ],
        "ddrl_prefixes": [],
    },
