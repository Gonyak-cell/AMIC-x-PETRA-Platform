...
APPENDIX_COLUMNS: dict[str, list[str]] = {
    AppendixType.LITIGATION: [
        "연번", "사건번호", "관할법원", "소송유형", "당사자", "소송물가액",
        "현재상태", "예상결과", "리스크등급", "비고",
    ],
    AppendixType.IP: [
        "연번", "권리유형", "등록번호", "명칭", "출원일", "등록일",
        "권리자", "존속기간", "실시계약", "비고",
    ],
    AppendixType.REAL_ESTATE: [
        "연번", "소재지", "면적(㎡)", "용도지역", "소유형태",
        "등기사항", "담보설정", "임차현황", "감정가(원)", "비고",
    ],
    AppendixType.CONTRACTS: [
        "연번", "계약명", "계약상대방", "계약유형", "계약금액",
        "계약기간", "해지조건", "COC조항", "리스크등급", "비고",
    ],
    AppendixType.INSURANCE: [
        "연번", "보험유형", "보험회사", "보험기간", "보험가입금액",
        "보험료", "주요면책사항", "갱신여부", "비고",
    ],
    AppendixType.PERMITS: [
        "연번", "인허가명", "관할기관", "허가번호", "허가일",
        "유효기간", "갱신여부", "양도가능성", "리스크등급", "비고",
    ],
}
