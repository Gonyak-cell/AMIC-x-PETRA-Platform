"""Platform-wide normalized evidence records."""
...
class EvidenceRecord(Base, TimestampMixin):
    """Cross-workstream evidence traceability rows."""
    ...
    workstream: Mapped[str] = mapped_column(String(30), nullable=False, index=True)
    section_type: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    item_id: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
