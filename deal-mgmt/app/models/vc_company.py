...
class VcCompany(Base, TimestampMixin):
    ...
    revenue: Mapped[Decimal | None] = mapped_column(Numeric(20, 2), nullable=True, comment="매출액(억원), DART 기준")
    revenue_year: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="매출 기준연도")
