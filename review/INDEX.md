...
> 최종 업데이트: 2026-02-17 21:53

## 카테고리별 요약

| 카테고리 | 총 건수 | 최근 문서 |
|---------|--------|----------|
| bugfix | 3건 | 20260217_2140_FDD_Deal_Creation_500_Fix.md |
| security | 1건 | 20260217_1716_Cookie_Auth_Cross_Backend.md |
| review | 1건 | 20260217_1824_KIIS_Fund_Search_Core_Feature_Audit.md |
| refactor | 0건 | — |
| a11y | 0건 | — |
| perf | 0건 | — |
| hotfix | 0건 | — |
| type | 0건 | — |
| build | 0건 | — |
| ui | 2건 | 20260217_2153_FDD_Deal_Form_Redesign.md |
