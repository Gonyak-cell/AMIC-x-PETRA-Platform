    ...
    def get_adjustment_rules(self) -> list[FDDAdjustmentRule]:
        return [
            ...
            FDDAdjustmentRule(
                ...
                keywords=[
                    "과징금", "regulatory fine", "제재", "penalty",
                    "벌금", "금감원", "FSS",
                ],
        ...
        return [
            FDDDebtClassification(
                ...
                additional_debt_like_keywords=[
                    "후순위채", "subordinated debt", "조건부자본",
                    "contingent capital", "CoCo", "신종자본증권",
                    "영구채", "perpetual bond", "하이브리드",
                ],
                additional_cash_like_keywords=[
                    "지급준비금", "reserve", "중앙은행예치금",
                ],
                special_treatments={
