    ...
    def get_adjustment_rules(self) -> list[FDDAdjustmentRule]:
        return [
            ...
            FDDAdjustmentRule(
                ...
                category="NORMALIZATION",
                keywords=[
                    "감가상각", "depreciation", "차량감가", "선박감가",
                    "항공기감가", "fleet depreciation",
                ],
            ...
            FDDAdjustmentRule(
                ...
                category="NON_RECURRING",
                keywords=[
                    "노선개편", "route optimization", "네트워크재편",
                    "허브이전", "거점이전",
                ],
        ...
        return [
            FDDDebtClassification(
                ...
                additional_debt_like_keywords=[
                    "차량리스", "선박금융", "ship finance", "항공기금융",
                    "fleet lease", "운송장비리스", "차량할부",
                ],
                additional_cash_like_keywords=[
                    "운임선수금", "freight prepayment",
                ],
                special_treatments={
