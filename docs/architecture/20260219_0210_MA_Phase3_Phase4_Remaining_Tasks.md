...
## 2. Phase 3: AI 계약분석 / 전자서명 / SPA / Closing
...
| Schema | 용도 |
|:---|:---|
| `ClosingChecklistOut` | Closing 항목 조회 |
...
| Method | Path | 설명 |
|:---|:---|:---|
| GET | `/transactions/{txn_id}/closing` | Closing 항목 목록 |
| GET | `/transactions/{txn_id}/closing/summary` | Closing 요약 |
...
| 훅 | 설명 |
|:---|:---|
| `useClosingChecklist(txnId)` | Closing 항목 목록 |
| `useClosingSummary(txnId)` | Closing 요약 |
...
| `closing` | Closing | closingItems.length | **3** |
